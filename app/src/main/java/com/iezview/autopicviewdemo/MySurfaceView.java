...
class MySurfaceView extends GLSurfaceView {
    ...
    public MySurfaceView(Context context, AttributeSet attrs) {
        ...
        Sensor mSensor = manager.getDefaultSensor(Sensor.TYPE_ORIENTATION);
        manager.registerListener(new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                ball.zAngle = -x + 90;
                ball.yAngle = z;//设置填充椭圆绕y轴旋转的角度
                ball.xAngle = y;//设置填充椭圆绕x轴旋转的角度
            }
...
//                ball.yAngle += (dx * TOUCH_SCALE_FACTOR) / 3;//设置填充椭圆绕y轴旋转的角度
//                ball.xAngle += (dy * TOUCH_SCALE_FACTOR) / 3;//设置填充椭圆绕x轴旋转的角度
//        }
